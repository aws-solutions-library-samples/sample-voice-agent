...
- **STT and/or TTS model provider** API keys (e.g. [Deepgram](https://console.deepgram.com/), [Cartesia](https://play.cartesia.ai/)) -- not needed for SageMaker mode
...
This Guidance focuses on a production-ready **cascading pipeline** (STT → LLM → TTS) using Pipecat on Amazon ECS Fargate with optional self-hosted STT/TTS on Amazon SageMaker AI.
...
| May 2026 | Architecture diagram update |
